                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">Add Question</h4>
                                    ...
                                    <form class="form" action="{{ route('question.store') }}" method="POST"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="question_ar" class="form-control"
                                                            value="{{ old('title_ar') }}" placeholder="Enter Arabic question"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="question_en" class="form-control"
                                                            value="{{ old('title_en') }}" placeholder="Enter English question"
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="la la-check-square-o"></i> Add Question
                                            </button>
                                        </div>
                                    </form>
                                </div>
