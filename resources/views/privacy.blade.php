...
<body>
    ...
    <p>This privacy policy applies to the Al Kimyai app (hereby referred to as "Application") for mobile devices that was created as a Free service. This service is intended for use "AS IS".</p>
    ...
    <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to chemistryapp1@gmail.com. The information that the Service Provider requests will be retained by them and used as described in this privacy policy.</p>
    ...
    <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at <a href="mailto:afterglow1100@gmail.com">afterglow1100@gmail.com</a> and they will respond in a reasonable time.</p>
    ...
    <p>This privacy policy is effective as of 2024-10-26.</p>
    ...
    <h2>Contact Us</h2>
    <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at <a href="mailto:afterglow1100@gmail.com">afterglow1100@gmail.com</a>.</p>
</body>
</html>
